...
3. Afterward go to the 'connected' directory inside the frontend folder and run npm run dev which should show this terminal
...
4. Open the website using the url provided by the terminal of the frontend terminal which be default should be http://localhost:3001
